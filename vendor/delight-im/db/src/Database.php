...
interface Database {
	 ...
	 *
	 * @param string|string[] $tableName the name of the table to insert into (or an array of controllers of the qualified name)
	 ...
	 *
	 * @param string|string[] $tableName the name of the table to update (or an array of controllers of the qualified name)
	 ...
	 *
	 * @param string|string[] $tableName the name of the table to delete from (or an array of controllers of the qualified name)
	 * @param array $whereMappings the mappings between columns and values to filter by
	 ...
	 *
	 * @param string|string[] $tableName the table name to quote (or an array of controllers of the qualified name)
